...
{   
    ...
    unsigned long long int t3; unsigned long long int t4;
	...
	printf("%9s:%4.3f seconds after previous frame,%2.3f FPS\n", time2str(buf2, t2 / (1 * 1000000ull)), (float)(t4 / (float)(1 * 1000000000000ull)), 1 / (float)(t4 / (float)(1 * 1000000000000ull)));
...
{   
    ...
    _specc::waitfor((8.217000000000000e+02 * 1000000000ull) / 8);
    blur_x(1520, 2704);
}
...
{   
    ...
    _specc::waitfor((8.955000000000000e+02 * 1000000000ull) / 8);
    blur_y(1520, 2704);
}
...
{   
    ...
    _specc::waitfor((530600 * 1000000ull));
